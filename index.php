    ...
    <section id="about">
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">BIENVENIDOS A NUESTRO SITIO WEB</h2>
                ...
                <div class="portfolio-item fibra">
                    <div class="portfolio-item-inner">
                        ...
                        <div class="portfolio-info" data-toggle="modal" data-target="#miniposte">
                            ...
                            <!-- Modal -->
                          <div class="modal fade" id="miniposte" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="sendemail.php">
                    <div class="col-lg-6 animated animate-from-left" style="opacity: 1; left: 0px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="subject" name="subject" class="form-control" placeholder="Herrajeria" required>
                        </div>
